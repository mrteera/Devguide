...
common_deps=$(wget https://raw.githubusercontent.com/mrteera/Devguide/master/build_scripts/ubuntu_sim_common_deps.sh -O -)
wget_return_code=$?
...
apt-get update -y
## Install Gazebo8
apt-get install gazebo8 -y
## For developers (who work on top of Gazebo) one extra package
apt-get install libgazebo8-dev -y
